...
- **No frontend test suite.** Backend business logic is covered by Pest; the frontend was verified by driving the real UI rather than by committed component tests. A Vitest suite around `lib/fees.ts`, the stores, and the base components is the first thing I'd add.
